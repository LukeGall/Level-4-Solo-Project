...
% It was important to ensure any user playing the puzzle couldn't complete it by cheating. While the completion of a puzzle is only for self satisfaction, future work could add leaderboards or user statistics detailing the number of puzzles users complete. 
...
\begin{table}[]
    \caption{The table of averaged monitored evaluation responses. Only questions with a five-point scale were averaged. Results were rounded to one significant figure.}\label{tab:monitoredResults}
    \resizebox{\textwidth}{!}{%
    \rowcolors{2}{}{gray!3}
    \begin{tabular}{@{}lll@{}}
        \textbf{Question}                                                                  & \textbf{Average Response} & \textbf{Standard Deviation} \\
        How easy was it to select and place pieces onto the board?                & 4.4              & 0.6               \\
        How easy was it to understand when a marble 'fell' based on the icon?     & 4.4              & 0.6               \\
        How easy was it to change the direction of a piece that was on the board? & 4.0              & 1.2                \\
        How intuitive was it that two Gear Bits were connected?                   & 2.8              & 0.5               \\
        How easy are the piece icons to uniquely identify?                        & 5.0              & 0.0                  \\
        How easy was it to understand the different playback options available?   & 4.0              & 1.0                  \\
        How clear was the puzzle list?                                            & 4.0              & 0.7                \\
        Was the information provided relevant in choosing a puzzle?               & 4.8              & 0.4                \\
        How useful was the difficulty filter?                                     & 4.2              & 1.1                \\
        How clear was it that some pieces couldn't be changed or deleted?         & 4.0              & 0.7                \\
        ...
        Was it easy to come up with a puzzle by thinking of the solution?         & 4.0              & 1.2                \\ 
    \end{tabular}%
    }
    \end{table}
...
\begin{itemize}
    ...
    % \item A few users didn't initially see that the puzzle page had a paginator at the bottom so assumed that the five initial puzzles shown were the only ones available. 
...
% \useunder{\uline}{\ul}{}
\begin{table}[]
    \caption{The table of averaged unmonitored evaluation results. Only questions asked with a five-point scale were averaged. Results were rounded to one significant figure.}\label{tab:unmonitoredResults}
    \resizebox{\textwidth}{!}{%
    \rowcolors{2}{}{gray!3}
    \begin{tabular}{@{}lll@{}}
    \textbf{Question}                                                                  & \textbf{Average Response} & \textbf{Standard Deviation} \\ 
    How easy was it to select and place pieces onto the board?                & 4.5              & 0.5               \\
    How easy was it to understand when a marble 'fell' based on the icon?     & 3.9            & 1.5               \\
    How easy was it to change the direction of a piece that was on the board? & 4.5              & 0.9               \\
    How easy are the piece icons to uniquely identify?                        & 4.9            & 0.4               \\
    How easy was it to understand the different playback options available?   & 3.8             & 0.9               \\
    How clear was the puzzle list?                                            & 4.5              & 0.8               \\
    Was the information provided relevant in choosing a puzzle?               & 4.5              & 0.8               \\
    How useful was the difficulty filter?                                     & 4.4            & 0.8               \\
    How clear was it that some pieces couldn't be changed or deleted?         & 4.0                & 1.1               \\
    How clear was it that you only had a certain number of pieces to complete the puzzle? & 4.1 & 1.1 \\
    How clear was the create starting set up phase?                           & 4.2              & 0.8               \\
    Was it easy to come up with a puzzle by thinking of the solution?         & 3.0                & 1.0                  \\ 
    \end{tabular}%
    }
    \end{table}
